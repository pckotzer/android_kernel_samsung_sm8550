...
KERNEL_TOOLS=/mnt/550gb/crdroid/prebuilts/kernel-build-tools/linux-x86/bin/
CLANG_PATH=/mnt/550gb/crdroid/prebuilts/clang/host/linux-x86/clang-r563880/bin/
